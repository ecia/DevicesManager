...
namespace DevicesManager.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            {
                UserInfo = currentUser.userInformations,
        ...
        public async Task<ActionResult> ManageLogins(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.FacebookError ? "Możliwe, że konto z którego próbujesz się zalogować istnieje już w naszej bazie. Spróbój wylogować się z Facebooka i powtórzyć próbę rejestracji, lub zalogować się na inne konto Facebook."
                : message == ManageMessageId.Error ? "Wystąpił błąd."
                : "";
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            if (user == null)
        ...
        public async Task<ActionResult> LinkLoginCallback()
        {
            ...
            return result.Succeeded ? RedirectToAction("ManageLogins") : RedirectToAction("ManageLogins", new { Message = ManageMessageId.FacebookError});
